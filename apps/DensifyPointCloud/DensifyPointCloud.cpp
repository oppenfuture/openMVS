...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	generic.add_options()
		...
		("algorithm,u",boost::program_options::value(&OPT::algorithm)->default_value(1),"use algorithm to estimate depth (2-nopatchmatch, 1-mvs, 0-gipuma)")
...
int main(int argc, LPCTSTR* argv)
{
	...
	Scene scene(OPT::nMaxThreads, OPT::exportDmapOnly);
