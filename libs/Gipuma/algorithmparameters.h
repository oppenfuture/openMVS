#pragma once
#ifndef _GIPUMA_ALGORITHM_PARAMETERS_H_
#define _GIPUMA_ALGORITHM_PARAMETERS_H_
#include "managed.h"
...
struct AlgorithmParameters : public Managed{
    ...
    AlgorithmParameters():
        ...
        box_hsize          (11), // filter kernel width CUDA
        box_vsize          (11), // filter kernel height CUDA
        ...
        no_texture_sim     (0.998f), // CUDA
        no_texture_per     (0.7f), // CUDA
        max_views          (9) {}
...
#endif // _GIPUMA_ALGORITHM_PARAMETERS_H_